...
> ## ⏭️ NEXT SESSION: **send the three documents, then run the demo** — then slice 5.1
> Build proceeds per `docs/build-playbook.md` — weeks 1–3 are ☑ and committed, 4.1 and 4.2 are ☑ and committed (`ce82e31`), **4.3 is ☑ and uncommitted**. The next unticked slice is **5.1** (repair flow G4).
>
...
> ## ⏭️ PREVIOUS SESSION: slice 4.2 — **week 4 is the client demo**
