...
namespace Api.Migrations
{
    ...
    [Migration("20260901111920_AddSyncBlockedUserStatus")]
    partial class AddSyncBlockedUserStatus
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("app_user", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_app_user_status", "[status] IN ('invited', 'active', 'inactive', 'sync_blocked')");
                        });
                });
