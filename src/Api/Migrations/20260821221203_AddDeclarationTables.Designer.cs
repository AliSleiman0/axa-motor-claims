...
namespace Api.Migrations
{
    ...
    [Migration("20260821221203_AddDeclarationTables")]
    partial class AddDeclarationTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Modules.Media.Document", b =>
                {
                    ...
                    b.ToTable("document", null, t =>
                        {
                            t.HasCheckConstraint("CK_document_bucket", "[bucket] IN ('approval_image', 'damage_diagram', 'expert_report', 'garage_car_photo', 'garage_documents', 'insured_car_photo', 'insured_documents', 'tp_car_photo', 'tp_documents', 'voice_note')");
