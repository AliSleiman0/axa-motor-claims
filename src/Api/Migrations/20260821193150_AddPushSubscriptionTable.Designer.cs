...
namespace Api.Migrations
{
    ...
    [Migration("20260821193150_AddPushSubscriptionTable")]
            ...
            modelBuilder.Entity("Api.Modules.Media.Document", b =>
                {
                    ...
                    b.ToTable("document", null, t =>
                        {
                            t.HasCheckConstraint("CK_document_bucket", "[bucket] IN ('damage_diagram', 'expert_report', 'insured_car_photo', 'insured_documents', 'tp_car_photo', 'tp_documents', 'voice_note')");
