...
namespace Api.Migrations
{
    ...
    [Migration("20260824181124_AddPublicDocumentBucket")]
    partial class AddPublicDocumentBucket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Modules.Media.Document", b =>
                {
                    ...
                    b.ToTable("document", null, t =>
                        {
                            t.HasCheckConstraint("CK_document_bucket", "[bucket] IN ('approval_image', 'broker_document', 'damage_diagram', 'discharge', 'expert_report', 'garage_car_photo', 'garage_documents', 'insured_car_photo', 'insured_documents', 'invoice', 'public_document', 'repair_photo', 'tp_car_photo', 'tp_documents', 'voice_note')");
