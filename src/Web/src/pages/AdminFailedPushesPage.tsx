 ...
 * until somebody presses Retry. Amber is `pending` with its next attempt more than one poll away —
  ...
  return (
    <tr>
      ...
      <td className="mono">
        ...
        {failed ? null : <span className="caption">{describeWait(row.nextRetryAt)}</span>}
      </td>
